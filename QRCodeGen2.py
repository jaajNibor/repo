...
class QRCodeGeneratorApp:
    def __init__(self, master):
        ...
        self.qr_image = None  # Assurez-vous que qr_image soit initialisé à None
        ...
        def generate_qr_code(self):
            ...
            if url:
                ...
                self.qr_image = ImageTk.PhotoImage(img)  # Conserver une référence à l'image
                
                # Utiliser un attribut de l'instance pour stocker l'image
                self.image_label.config(image=self.qr_image)
                self.image_label.image = self.qr_image  # Ajout de cette ligne pour garder une référence
            else:
